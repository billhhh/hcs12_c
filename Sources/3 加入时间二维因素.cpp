    ...
    for (;;) 			
      {
        ...
        int a[10][2] = {{1,2},{12,1},{3,3},{12,1},{1,5},{14,1},{3,2},{14,1},{5,5},{13,1}};  
    
        for(int i=0;i<10;++i) {
          
          for(int j=0;j<1000/a[i][0]*a[i][1];++j) {
            PTT = PTT | 0x20;      //make PT5=1
            MSDelay(a[i][0]);         //change the delay size to see what happens
            PTT = PTT & 0xDF;      //Make PT5=0
            MSDelay(a[i][0]);         //change delay size....
          }
